...
namespace doanimate {
    namespace types {
        ...
        const std::unordered_map<TypeInfo, std::string> names { {TypeInfo::boolean, "boolean"}, {TypeInfo::integer, "integer"}, {TypeInfo::number, "number"}, {TypeInfo::string, "string"}, {TypeInfo::any, "any"}
        };

    ...
    namespace types {
        namespace implementation {
            ...
            const TypeInfo TypeInfo::renderable = TypeInfo::function(
                TypeInfo::color, {TypeInfo::position2d}
            ).labeled("renderable");
            ...
            const TypeInfo TypeInfo::interactable = TypeInfo::function(
                TypeInfo::tuple({
                    ...
                    TypeInfo::function(  // drag
                        TypeInfo::list(TypeInfo::any), {TypeInfo::position}
                    ),
        ...
        const std::unordered_map<TypeInfo, std::string> names { {TypeInfo::boolean, "boolean"}, {TypeInfo::integer, "integer"}, {TypeInfo::number, "number"}, {TypeInfo::string, "string"}, {TypeInfo::any, "any"}, {TypeInfo::none, "none"}
        };
